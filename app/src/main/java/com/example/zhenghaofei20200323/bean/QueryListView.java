...
public class QueryListView {
    ...
    public static class ResultBean {
        ...
        Boolean isAllnamecheack=false;

        public Boolean getAllnamecheack() {
            return isAllnamecheack;
        }

        public void setAllnamecheack(Boolean allnamecheack) {
            isAllnamecheack = allnamecheack;
        }
